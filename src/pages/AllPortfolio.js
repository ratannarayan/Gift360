        ...
        <Tabs className="flex flex-col px-4">
          <TabList>
            <div className="flex flex-row mb-5">
              <Tab>
                <button className="font-normal px-5 py-2 mr-3 text-theme-red text-lg border border-theme-red rounded-full transition duration-300 hover:bg-theme-red hover:text-white focus:outline-none focus:bg-theme-red focus:text-white">Family</button>
              </Tab>
              <Tab>
                <button className="font-normal px-5 py-2 mr-3 text-theme-red text-lg border border-theme-red rounded-full transition duration-300 hover:bg-theme-red hover:text-white focus:outline-none focus:bg-theme-red focus:text-white">Friends</button>
              </Tab>
              <Tab>
                <button className="font-normal px-8 py-2 text-theme-red text-lg border border-theme-red rounded-full transition duration-300 hover:bg-theme-red hover:text-white focus:outline-none focus:bg-theme-red focus:text-white">All</button>
              </Tab>
            </div>
          </TabList>
