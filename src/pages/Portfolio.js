...
export default function Portfolio({ data }) {
  return (
    <section className="container mx-auto flex flex-col items-center mt-20">
      <Fade bottom>
        <h1 className="text-5xl text-theme-blue text-center font-bold">Our Selected Gifts for You</h1>

        <p className="font-light text-lg text-gray-400 text-center mb-12">
          We are ready to scale up your gift choice with our great work result.
        </p>
      </Fade>
